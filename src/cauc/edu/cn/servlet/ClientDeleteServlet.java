...
public class ClientDeleteServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		ClientServices Clientserive = new ClientServices();
		...
		Gson gson = new Gson();
		//boolean Verifyaddvehicle = vehicleserive.DelVehicle(vehicle);
		boolean VerifyAddClient = Clientserive.DelClient(Client);
		...
		RecordAssist recordAssist = new RecordAssist("删除设备"+clientnum, userInfo);
