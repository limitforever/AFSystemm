...
public class EnvironmentServlet extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// TODO Auto-generated method stub
		{
			...
			Gson gson = new Gson();
			Map parameterMap = gson.fromJson(chaxuntiaojian, Map.class);
			...
			try {
				PaginationInfo = new EnvironmentServices().queryEnvironmentByPagination(currentPageNum,rows,parameterMap);
