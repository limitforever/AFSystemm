...
@WebServlet("/OilWorkerServlet")
public class OilWorkerServlet extends HttpServlet
{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try 
		{
			PaginationInfo = workerService.queryWorkerByPagination(currentPageNum,rows,fromJson);
		} 
