...
@WebServlet("/NowWorkSheetServlet")
public class NowWorkSheetServlet extends HttpServlet
{
	/**
	 * 
	 */
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		updatedateworkersheetStateService.UpdateworkersheetState_2(fuelSheetInfo);


		String chaxuntiaojian = request.getParameter("chaxuntiaojian2");
		Gson gson = new Gson();
