...
//web 3.0的新写法
@WebServlet("/OilWorkerModfiyServlet")
public class OilWorkerModfiyServlet extends HttpServlet {
	...
	{	
		...
		boolean VerifyupdateWorker = WorkerService.UpdateWorker(oilworker);
		...
		RecordAssist recordAssist = new RecordAssist("更新加油人员"+ workeruserid +"的信息", userInfo);
		
		if(VerifyupdateWorker)
		{
