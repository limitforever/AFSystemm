...
@WebServlet("/FlightDynamicUpdateServlet")
public class FlightDynamicUpdateServlet extends HttpServlet{
	...
	{	
		...
		FlightInfoServices flightInfoServices = new FlightInfoServices();
		
		PaginationInfo PaginationInfo = null;
		
		try 
		{
			PaginationInfo = flightInfoServices.queryFlightDictionaryByPagination(currentPageNum,rows,fromJson);
		} 
