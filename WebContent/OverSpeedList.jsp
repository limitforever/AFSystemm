...
<body style="font-family: '幼圆'">
	...
	<div class="easyui-tabs" style="width:1000px;height:500px">
		<div title="超速记录" style="padding:10px">
		<table id="queryConditionTable">
		  <tr>
		      <td>员工编号：</td>
		      <td><input type="text" id="workerusername"  style="width:200px"></td>
	...
	<script type="text/javascript">
        ...
        function getDataGrid(){
            ...
            $('#dg').datagrid({    
        	    url:contextPath+'/VehicleLogServlet',  
        	    loadMsg:'正在读取....数据，请稍后...',
        	    pagination : true,
        	    singleSelect : true,
        	    rownumbers:true,
        	    ...
        	    sortOrder : 'ASC',
        	    columns:[[    
        	        {field:'workeruserid',title:'员工姓名',width:'220px',sortable:true},      
        	        {field:'vehiclenum',title:'加油车牌号',width:'230px',sortable:true}, 
        	        {field:'speed',title:'超速速度',width:'230px',sortable:true}, 
        	        {field:'logtime',title:'超速时间',width:'230px',sortable:true},        
        	    ]]
        	});
        }  
        </script>
