...
<body style="font-family: '幼圆'">
	...
	<div class="easyui-tabs" style="width:1000px;height:550px">
		...
		<table id="queryConditionTable">
			...
			<tr>
				...
				<td style="padding-left:20px">员工姓名：</td>
				<td><input type="text" id="username_l"></td>
    ...
    <div id="toolbar">
        ...
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-pencil" plain="true" onclick="resetpwd()">重置密码</a>
    </div>
    ...
    <div id="dlg" class="easyui-dialog" style="width:400px;height:350px;padding:10px 20px"
        ...
        <form id="fm" method="post" novalidate>
            <div class="fitem">
                <label>员工号</label>
                <input name="usernum" class="easyui-textbox">
            </div>
            <div class="fitem">
                <label>姓名</label>
    ...
    <script type="text/javascript">
        ...
        function getDataGrid(){
            ...
            $('#dg').datagrid({    
        	    ...
        	    sortOrder : 'ASC',
        	    columns:[[    
        	        {field:'usernum',title:'员工号',width:'150px',sortable:true},    
        	        {field:'username',title:'姓名',width:'150px',sortable:true},    
        ...
        function editUser(){
            ...
            if (row){
                ...
                $('#fm').form('load',row);
                url = contextPath+'/UserModfiyServlet?id='+row.userid+'&usernum='+row.usernum;   
        ...
        function destroyUser()
        {
            ...
            if (row)
            {
                ...
                {               	
                    if (r)
                    {                   	
                        $.post(contextPath+'/UserDeleteServlet',{id:row.userid,usernum:row.usernum},function(result)
                        {   
            ...
            {           	
                ...
                if (row)
                {
                    ...
                    {               	
                        if (r)
                        {                   	
                            $.post(contextPath+'/UserResetPasswordServlet',{id:row.userid,usernum:row.usernum},function(result){   //！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
                                if (result.resultMsg=='ok')
                                {
                                	$.messager.show
                                	({    // show error message
