...
@WebServlet("/OperatorRecordServlet")
public class OperatorRecordServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		OperatorRecordServices operatorRecordServices = new OperatorRecordServices();
		
		PaginationInfo PaginationInfo = null;
		try 
		{
			PaginationInfo = operatorRecordServices.queryOperatoRrecordByPagination(currentPageNum,rows,fromJson);
		} 
