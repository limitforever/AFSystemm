...
public class pushtoSinglebatch {
	...
	// ------------设置应用参数---------------
	static String appId = "QZWmnKbilg6HvM03w1oFp";
	static String appkey = "vaJp5AaHNk8SHgrld9xfY";
	static String master = "x3JDH8gpjZ5oRYaVVnbU32";
	static String CID = "429702dca1324160db2fc5f5da4d3575";
