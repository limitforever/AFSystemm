...
@WebServlet("/FuelSheetServlet")
public class FuelSheetServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		Map parameterMap = gson.fromJson(request.getParameter("chaxuntiaojian"), Map.class);
		...
		try {
			PaginationInfo = new FuelSheetSerivces().queryFuelSheetByPagination(currentPageNum,rows,parameterMap);
